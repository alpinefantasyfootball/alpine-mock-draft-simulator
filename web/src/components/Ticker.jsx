...
// parseGenerated/timeAgo moved to dataFreshness.js when the footer
// turned out to be deriving the same fact a second way, and getting a
// different answer. Both read this now.
